...
DELIMITER #
CREATE PROCEDURE sp_consultaatendimentos(p_tec varchar(20))
BEGIN
...
BEGIN
    ...
    mkradius.sis_cliente.ssid, mkradius.sis_cliente.vendedor,
    ...
    mkradius.sis_cliente.tipo, mkradius.sis_cliente.data_ins, mkradius.sis_cliente.altsenha)
    SELECT 
    mkradius.sis_solic.nome, mkradius.sis_solic.email, mkradius.sis_solic.endereco,
    mkradius.sis_solic.bairro, mkradius.sis_solic.cidade,
    ...
    mkradius.sis_solic.datainst, mkradius.sis_solic.login, mkradius.sis_solic.senha,
    ...
    mkradius.sis_solic.nome,
    'todos'/*ramal*/, 'nao'/*autoip*/, 'nao'/*automac*/,
    '1'/*conta*/, 'nenhuma'/*chavetipo*/, 'outros'/*grupo*/,
    'outros'/*ssid*/, 'nenhum'/*vendedor*/,
...
BEGIN
	UPDATE mkradius.sis_solic SET
    mkradius.sis_solic.obs = concat(mkradius.sis_solic.obs, p_texto),
